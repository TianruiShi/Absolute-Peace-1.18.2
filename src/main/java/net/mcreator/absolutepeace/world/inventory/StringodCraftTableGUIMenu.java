...
public class StringodCraftTableGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public StringodCraftTableGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(AbsolutepeaceModMenus.STRINGOD_CRAFT_TABLE_GUI, id);
		...
		this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 137, 29) {
			@Override
