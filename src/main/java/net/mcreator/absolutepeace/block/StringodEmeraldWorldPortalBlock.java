...
import net.mcreator.absolutepeace.world.teleporter.StringodEmeraldWorldTeleporter;
import net.mcreator.absolutepeace.world.teleporter.StringodEmeraldWorldPortalShape;

import java.util.Random;
import java.util.Optional;

public class StringodEmeraldWorldPortalBlock extends NetherPortalBlock {
	public StringodEmeraldWorldPortalBlock() {
	...
	public static void portalSpawn(Level world, BlockPos pos) {
		Optional<StringodEmeraldWorldPortalShape> optional = StringodEmeraldWorldPortalShape.findEmptyPortalShape(world, pos, Direction.Axis.X);
	...
	public BlockState updateShape(BlockState p_54928_, Direction p_54929_, BlockState p_54930_, LevelAccessor p_54931_, BlockPos p_54932_,
		...
		return !flag && !p_54930_.is(this) && !(new StringodEmeraldWorldPortalShape(p_54931_, p_54932_, direction$axis1)).isComplete()
		...
		if (!entity.isPassenger() && !entity.isVehicle() && entity.canChangeDimensions() && !entity.level.isClientSide() && true) {
			if (entity.isOnPortalCooldown()) {
				entity.setPortalCooldown();
					...
					new ResourceLocation("absolutepeace:stringod_emerald_world"))) {
				entity.setPortalCooldown();
	...
	private void teleportToDimension(Entity entity, BlockPos pos, ResourceKey<Level> destinationType) {
		entity.changeDimension(entity.getServer().getLevel(destinationType),
				new StringodEmeraldWorldTeleporter(entity.getServer().getLevel(destinationType), pos));
	}
}
